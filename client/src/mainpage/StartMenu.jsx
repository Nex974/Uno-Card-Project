...
<div className="flex-none w-80" style={{ marginTop: '-70px' }}>
  ...
  <form className="flex-auto px-9">
    <div className="flex flex-wrap">
      <div className="w-full flex-none mt-2 mb-6 order-1 text-5xl font-bold text-violet-600">
        edno
      </div>
    </div>
    ...
    <div className="flex space-x-4 mb-5 text-sm font-medium">
      <div className="flex-auto flex space-x-4">
        <button className="flex items-center h-10 px-6 font-semibold rounded-full bg-violet-600 text-white" type="submit">
          Join Game
        </button>
        <button className="bg-sky-400 flex items-center h-10 px-6 font-semibold rounded-full border border-slate-200 text-slate-900" type="button">
          Create Game
        </button>
      </div>
    </div>

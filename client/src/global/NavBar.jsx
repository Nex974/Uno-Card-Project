  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <button onClick={() => navigate('/')} className="!flex !items-center !space-x-3 !rtl:space-x-reverse !bg-transparent !p-0">
      ...
      <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        {!openShop && 
        <li>
          <button onClick={handleOpenShop} className="bg-sky-400 block !py-2 !px-3 !text-gray-900 !rounded !hover:bg-gray-100 !md:hover:bg-transparent !md:border-0 !md:hover:text-blue-700 !md:p-0 !dark:text-white !md:dark:hover:text-blue-500 !dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-white">Open Shop</button>
        </li>
        }
